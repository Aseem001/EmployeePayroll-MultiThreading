...
namespace EmployeePayroll_MultiThreading
{
    ...
    public class EmployeePayrollOperation
    {
        ...
        /// <summary>
        /// UC 5 : Adds the employee list to multiple tables with synchronization.
        /// </summary>
        /// <param name="employeeList">The employee list.</param>
        ...
        /// <summary>
        /// UC 6 : Updates the salary details using threads with synchronization.
        /// </summary>
        /// <param name="employeeList">The employee list.</param>
        ...
        /// <summary>
        /// Updates the salary details into multiple table.
        /// </summary>
